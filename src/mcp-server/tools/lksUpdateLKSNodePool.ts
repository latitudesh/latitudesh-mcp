...
import { UpdateLksNodePoolRequest$zodSchema } from "../../models/updatelksnodepoolop.js";
import { formatResult, ToolDefinition } from "../tools.js";

const args = {
  request: UpdateLksNodePoolRequest$zodSchema,
};
...
`,
  ...
  tool: async (client, args, ctx) => {
    const [result] = await lksUpdateLKSNodePool(
      client,
      args.request,
