...
import {
  ...
  DeleteStorageAccessKeysUsernameRequest$zodSchema,
} from "../models/deletestorageaccesskeysusernameop.js";
...
export function objectStorageDeleteStorageAccessKeysUsername(
  ...
  request: DeleteStorageAccessKeysUsernameRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => DeleteStorageAccessKeysUsernameRequest$zodSchema.parse(value$),
