...
import {
  ...
  UpdateElasticIpRequest$zodSchema,
  UpdateElasticIpResponse,
  UpdateElasticIpResponse$zodSchema,
} from "../models/updateelasticipop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdateElasticIpRequest$zodSchema.parse(value$),
  ...
  const body$ = encodeJSON("body", payload$.update_elastic_ip, {
    explode: true,
  });
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(202, UpdateElasticIpResponse$zodSchema, {
      ctype: "application/vnd.api+json",
      key: "elastic_ip",
    }),
    M.json([403, 404, 422], UpdateElasticIpResponse$zodSchema, {
      ctype: "application/vnd.api+json",
      key: "error_object",
    }),
