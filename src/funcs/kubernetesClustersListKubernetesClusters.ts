 ...
 */
export function kubernetesClustersListKubernetesClusters(
  client$: LatitudeshCore,
  request: ListKubernetesClustersRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ListKubernetesClustersRequest$zodSchema.parse(value$),
  ...
  const body$ = null;
  const path$ = pathToFunc("/kubernetes_clusters")();
