...
import {
  ...
  IndexVirtualMachineResponse$zodSchema,
...
export function virtualMachinesList(
  ...
  request?: IndexVirtualMachineRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => IndexVirtualMachineRequest$zodSchema.optional().parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.nil(200, IndexVirtualMachineResponse$zodSchema),
