 ...
 * - `reboot`
 */
export function serversRunAction(
  client$: LatitudeshCore,
  request: CreateServerActionRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateServerActionRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/servers/{server_id}/actions")(
    pathParams$,
  );
