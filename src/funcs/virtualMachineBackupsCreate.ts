...
import {
  ...
  VirtualMachineBackupPayload$zodSchema,
} from "../models/virtualmachinebackuppayload.js";
 ...
 */
export function virtualMachineBackupsCreate(
  client$: LatitudeshCore,
  request: VirtualMachineBackupPayload,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => VirtualMachineBackupPayload$zodSchema.parse(value$),
