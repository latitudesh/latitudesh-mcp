 ...
 */
export function vpnSessionsRefreshPassword(
  client$: LatitudeshCore,
  request: PutVpnSessionRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => PutVpnSessionRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/vpn_sessions/{vpn_session_id}/refresh_password")(
    pathParams$,
  );
