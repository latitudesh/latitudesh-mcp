...
import {
  ...
  DeleteKubernetesClusterRequest$zodSchema,
} from "../models/deletekubernetesclusterop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => DeleteKubernetesClusterRequest$zodSchema.parse(value$),
  ...
  >(
    ...
    M.json([401, 403, 404, 422], ErrorObject$zodSchema, {
