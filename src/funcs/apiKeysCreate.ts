...
import {
  CreateApiKey,
  CreateApiKey$zodSchema,
} from "../models/createapikey.js";
...
import {
  PostApiKeyResponse,
  PostApiKeyResponse$zodSchema,
} from "../models/postapikeyop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateApiKey$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/auth/api_keys")();
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(201, PostApiKeyResponse$zodSchema, {
