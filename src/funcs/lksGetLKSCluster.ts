...
import {
  ...
  GetLksClusterRequest$zodSchema,
} from "../models/getlksclusterop.js";
 ...
 */
export function lksGetLKSCluster(
  client$: LatitudeshCore,
  request: GetLksClusterRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetLksClusterRequest$zodSchema.parse(value$),
