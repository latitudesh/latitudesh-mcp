...
import {
  ...
  ListElasticIpsRequest$zodSchema,
  ListElasticIpsResponse,
  ListElasticIpsResponse$zodSchema,
} from "../models/listelasticipsop.js";
...
export function elasticIpsListElasticIps(
  ...
  request?: ListElasticIpsRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ListElasticIpsRequest$zodSchema.optional().parse(value$),
  ...
  const body$ = null;
  const path$ = pathToFunc("/elastic_ips")();
