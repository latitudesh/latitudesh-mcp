...
import {
  CreateLksCluster,
  CreateLksCluster$zodSchema,
} from "../models/createlkscluster.js";
 ...
 */
export function lksCreateLKSCluster(
  client$: LatitudeshCore,
  request: CreateLksCluster,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateLksCluster$zodSchema.parse(value$),
