...
import {
  ...
  CreateVirtualMachineActionRequest$zodSchema,
  CreateVirtualMachineActionResponse,
  CreateVirtualMachineActionResponse$zodSchema,
} from "../models/createvirtualmachineactionop.js";
...
export function virtualMachinesCreateVirtualMachineAction(
  ...
  request: CreateVirtualMachineActionRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateVirtualMachineActionRequest$zodSchema.parse(value$),
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.nil(201, CreateVirtualMachineActionResponse$zodSchema),
