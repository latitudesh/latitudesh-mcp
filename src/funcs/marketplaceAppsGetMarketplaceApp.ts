...
import {
  ...
  GetMarketplaceAppRequest$zodSchema,
} from "../models/getmarketplaceappop.js";
...
export function marketplaceAppsGetMarketplaceApp(
  ...
  request: GetMarketplaceAppRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetMarketplaceAppRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/marketplace_apps/{id}")(
    pathParams$,
  );
