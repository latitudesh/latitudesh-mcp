...
import {
  ...
  GetAllFirewallAssignmentsRequest$zodSchema,
  GetAllFirewallAssignmentsResponse,
  GetAllFirewallAssignmentsResponse$zodSchema,
} from "../models/getallfirewallassignmentsop.js";
...
export function firewallsGetAllFirewallAssignments(
  ...
  request?: GetAllFirewallAssignmentsRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) =>
      GetAllFirewallAssignmentsRequest$zodSchema.optional().parse(value$),
