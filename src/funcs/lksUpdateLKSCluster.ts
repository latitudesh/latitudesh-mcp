...
import {
  ...
  UpdateLksClusterRequest$zodSchema,
} from "../models/updatelksclusterop.js";
 ...
 */
export function lksUpdateLKSCluster(
  client$: LatitudeshCore,
  request: UpdateLksClusterRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => UpdateLksClusterRequest$zodSchema.parse(value$),
  ...
  const body$ = encodeJSON("body", payload$.update_lks_cluster, {
    explode: true,
  });
  ...
  const path$ = pathToFunc("/lks/clusters/{id}")(
    pathParams$,
  );
