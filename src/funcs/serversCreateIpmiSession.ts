 ...
 */
export function serversCreateIpmiSession(
  client$: LatitudeshCore,
  request: CreateIpmiSessionRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateIpmiSessionRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/servers/{server_id}/remote_access")(
    pathParams$,
  );
