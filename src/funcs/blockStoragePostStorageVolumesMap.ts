...
import {
  ...
  PostStorageVolumesMapRequest$zodSchema,
} from "../models/poststoragevolumesmapop.js";
...
export function blockStoragePostStorageVolumesMap(
  ...
  request: PostStorageVolumesMapRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => PostStorageVolumesMapRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/storage/volumes/{id}/map")(
    pathParams$,
  );
