...
import {
  ...
  PostStorageAccessKeysRequest$zodSchema,
} from "../models/poststorageaccesskeysop.js";
 ...
 */
export function objectStoragePostStorageAccessKeys(
  client$: LatitudeshCore,
  request: PostStorageAccessKeysRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => PostStorageAccessKeysRequest$zodSchema.parse(value$),
