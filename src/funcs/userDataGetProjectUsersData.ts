 ...
 */
export function userDataGetProjectUsersData(
  client$: LatitudeshCore,
  request: GetProjectUsersDataRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetProjectUsersDataRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/projects/{project_id}/user_data")(
    pathParams$,
  );
