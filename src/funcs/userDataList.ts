...
import {
  GetUsersDataRequest,
  GetUsersDataRequest$zodSchema,
  GetUsersDataResponse,
  GetUsersDataResponse$zodSchema,
} from "../models/getusersdataop.js";
...
export function userDataList(
  ...
  request?: GetUsersDataRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetUsersDataRequest$zodSchema.optional().parse(value$),
