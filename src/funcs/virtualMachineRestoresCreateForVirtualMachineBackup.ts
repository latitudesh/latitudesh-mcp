...
import {
  ...
  CreateVirtualMachineRestoreRequest$zodSchema,
} from "../models/createvirtualmachinerestoreop.js";
...
export function virtualMachineRestoresCreateForVirtualMachineBackup(
  ...
  request: CreateVirtualMachineRestoreRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => CreateVirtualMachineRestoreRequest$zodSchema.parse(value$),
