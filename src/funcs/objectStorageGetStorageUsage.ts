...
import {
  ...
  GetStorageUsageRequest$zodSchema,
} from "../models/getstorageusageop.js";
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetStorageUsageRequest$zodSchema.parse(value$),
  ...
  const query$ = encodeFormQuery({
    "filter[end_date]": payload$.filterEndDate,
    "filter[project]": payload$.filterProject,
    "filter[start_date]": payload$.filterStartDate,
    "filter[storage_id]": payload$.filterStorageId,
  });
