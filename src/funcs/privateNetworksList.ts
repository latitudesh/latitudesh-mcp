...
import {
  ...
  GetVirtualNetworksRequest$zodSchema,
  GetVirtualNetworksResponse,
  GetVirtualNetworksResponse$zodSchema,
} from "../models/getvirtualnetworksop.js";
 ...
 */
export function privateNetworksList(
  client$: LatitudeshCore,
  request?: GetVirtualNetworksRequest | undefined,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => GetVirtualNetworksRequest$zodSchema.optional().parse(value$),
  ...
  const body$ = null;
  const path$ = pathToFunc("/virtual_networks")();
  ...
  const [result$] = await M.match<
    ...
    | ConnectionError
  >(
    M.json(200, GetVirtualNetworksResponse$zodSchema, {
