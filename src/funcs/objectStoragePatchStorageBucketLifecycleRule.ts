...
import {
  ...
  PatchStorageBucketLifecycleRuleRequest$zodSchema,
} from "../models/patchstoragebucketlifecycleruleop.js";
...
export function objectStoragePatchStorageBucketLifecycleRule(
  ...
  request: PatchStorageBucketLifecycleRuleRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => PatchStorageBucketLifecycleRuleRequest$zodSchema.parse(value$),
