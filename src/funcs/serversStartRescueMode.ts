 ...
 */
export function serversStartRescueMode(
  client$: LatitudeshCore,
  request: ServerStartRescueModeRequest,
...
> {
  const parsed$ = safeParse(
    request,
    (value$) => ServerStartRescueModeRequest$zodSchema.parse(value$),
  ...
  const path$ = pathToFunc("/servers/{server_id}/rescue_mode")(
    pathParams$,
  );
